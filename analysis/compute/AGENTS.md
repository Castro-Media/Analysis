...
9. Last is a citaiton section (with a heading), including links to all the sources cited, plus a mirror link to a local pdf copy of the source at the time when it was cited.
